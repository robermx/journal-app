...
export const RegisterPage = () => {
  return (
    <AuthLayout>
      ...
      <form>
        <Grid container>
          <InputComponent label="Complete Name" type="text" placeholder="Your Name" />
          ...
          <Grid container spacing={2} sx={{ mb: 1 }}>
            <ButtonComponent value="Sign up" fullButton={true} />
          </Grid>
          <LinkComponent text="Already" textLink="Registered" path={'/auth/login'} />
        </Grid>
      </form>
    </AuthLayout>
  );
